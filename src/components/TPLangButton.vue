<template>
    <div class="dropdown dropdown-end">
        <TPButton tabindex="0" size="sm" role="button" icon="language" class="btn-circle btn-ghost"
            title="Change Langage Icon" name="Change Langage Icon" />
        <ul tabindex="0"
            class="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow border-2 border-[#25499A]">
